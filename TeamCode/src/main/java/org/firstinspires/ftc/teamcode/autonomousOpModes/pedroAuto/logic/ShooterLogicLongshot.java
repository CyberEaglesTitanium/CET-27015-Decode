...
public class ShooterLogicLongshot {
    ...
    private double FLICK_HAMMER_TIME = 0.8;
    private double FLICK_START_TIME = 0.8;
    private double LOAD_LOAD_TIME = 0.8;
    private double LOAD_UNLOAD_TIME = 0.8;

    public int shotsRemaining = 0;
    private int index = 3;

    private double TARGET_FLYWHEEL_POWER = 0.8;

    private double MAX_FLYWHEEL_TIME = 7;
