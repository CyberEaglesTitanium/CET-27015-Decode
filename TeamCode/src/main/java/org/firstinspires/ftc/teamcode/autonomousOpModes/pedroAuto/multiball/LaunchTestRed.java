...
public class LaunchTestRed extends OpMode {
    ...
    private final Pose startPose = new Pose(124, 120, Math.toRadians(135));
    private final Pose shootPose = new Pose(94, 96, Math.toRadians(135));
    private final Pose intakeStart = new Pose(96, 83, Math.toRadians(180));
    private final Pose intakePosition1 = new Pose(107, 83, Math.toRadians(180));
    private final Pose intakePosition2 = new Pose(113.5, 83, Math.toRadians(180));
    private final Pose intakePosition3 = new Pose(126, 83, Math.toRadians(180));
    private final Pose intake1startPose = new Pose(96, 83, Math.toRadians(180));
    private final Pose endPose = new Pose(104, 88, Math.toRadians(135));
