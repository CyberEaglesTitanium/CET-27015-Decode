...
@Autonomous(name = "6-Ball Test (Blue) Old", group = "Autonomous")
public class LaunchTestOld extends OpMode {
    ...
    private ShooterLogicQuickdrawOld shooter = new ShooterLogicQuickdrawOld();
